...
<div style="font-size: 8px; text-align: right;float:right;width:100%;margin-right:8px;">
  <span><a href="https://github.com/byxorna/resume/commit/$commit">byorna/resume@$tag</a> (<a href="https://github.com/byxorna/resume/commit/$commit">$commit_short</a>) $(date -u)</span>
</div>
_EOF_
